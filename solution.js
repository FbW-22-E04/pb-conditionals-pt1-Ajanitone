...
if (a < b) {
  console.log("03: b is the biggest");
} else if (c > b && c > a) {
  console("03: c is the biggest");
} else {
  console.log("03:None of the numbers are bigger");
}

if (int1 < int2) {
  console.log("03a: int2 is the biggest");
} else if (int3 > int2 && int3 > int1) {
  console.log("03a: int3 is the biggest");
} else {
  console.log("03a:None of the numbers are bigger");
}
...
if (str == str.includes("py")) {
  console.log("04:", str);
} else {
  console.log(`04: ${str1}${str}`);
}
...
if (int4 % 7 || (int4 % 11 && int5 % 7) || int5 % 11) {
  console.log();
}
...
// 09.Calculate the sum of int4 and int5. If the two values are equal, then print triple their sum. otherwise just return their sum.

if (int4 + (int5 % 2)) {
  console.log("09:", (int4 + int5) * 3);
} else {
  console.log("09:", int4 + int5);
}
...
if (int5 > 19) {
  console.log("10:", (int5 - 19) * 2);
} else {
  console.log("10:", int5 - 19);
}
